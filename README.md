...
The release variant is `0.2.15` (`versionCode=17`). See [release preparation](docs/release.md) for unsigned artifacts, local QA signing, and distribution signing. No signing key belongs in this repository.
