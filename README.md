...
The release variant is `0.2.9` (`versionCode=11`). See [release preparation](docs/release.md) for unsigned artifacts, local QA signing, and distribution signing. No signing key belongs in this repository.
