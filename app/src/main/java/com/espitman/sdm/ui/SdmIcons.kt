...
internal object SdmIcons {
    ...
    val SortAscending = outline("SortAscending", "M7 19V5m0 0-3 3m3-3 3 3M13 7h7M13 12h5M13 17h3")
    ...
    val PrivateTab = outline("PrivateTab", "M5 10h14l-2 7H7zM9 10l1-4h4l1 4M9 14h.1M15 14h.1")
